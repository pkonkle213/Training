    ...
    public partial class Training : BasePageWithIoC
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                List<ProductCategory> productCategories = ProductDAO.GetProductCategories();
        ...
        protected void SetSubCategories(object sender, EventArgs e)
        {
            ...
            List<ProductSubCategory> subCategories = ProductDAO.GetProductSubcategories(DropCategory.SelectedValue);
        ...
        {
            List<Product> products = ProductDAO.GetProducts(DropSubCategory.SelectedValue);
